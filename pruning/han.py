"""
 ...
 #
 # Description: Strategy for Han et al. (2015) pruning
 #
"""
...
class PruningHparams(hparams.PruningHparams):
    ...
    _name = 'Hyperparameters for Han et al. Pruning'
    _description = 'Hyperparameters that modify the way pruning occurs.'
    _pruning_fraction = 'The fraction of weights to prune from the network.'
    _layers_to_ignore = 'A comma-separated list of tensors that should not be pruned.'
