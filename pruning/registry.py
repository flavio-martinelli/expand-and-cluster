"""
 ...
 #
 # Description: Registry for pruning strategies
 #
"""
...
from pruning import sparse_global, FC19, han

registered_strategies = {'sparse_global': sparse_global.Strategy, 'fc19': FC19.Strategy,
                         'han': han.Strategy}

rewinding_strategies = ['sparse_global', 'fc19']
