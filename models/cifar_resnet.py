...
class Model(base.Model):
    ...
    class Block(nn.Module):
        ...
        def __init__(self, f_in: int, f_out: int, act_fun, downsample=False):
    ...
    def __init__(self, plan, initializer, act_fun, outputs=None):
    ...
    def forward(self, x):
        out = self.act_fun(self.bn(self.conv(x)))
        out = self.blocks(out)
