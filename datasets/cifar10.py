"""
 ...
 #
 # Description: CIFAR10 dataset class
 #
"""
...
class Dataset(base.ImageDataset):
    ...
    @staticmethod
    def get_boruta_mask():
        # load the cifar10_boruta_mask.npy file and fix the permutation
        import numpy as np
        mask = np.load(os.path.join(get_platform().boruta_root, 'cifar10_boruta_mask.npy')).reshape(32, 32, 3)
        return mask.transpose(2, 0, 1).reshape(-1)
